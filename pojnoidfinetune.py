...
import network
import pycparser
from sampleC import _traverse_tree_noid
...
if __name__ == '__main__':
    ...
    listta = list()
    feature_size = 100
    listchar = ['FileAST', 'FuncDef', 'Decl', 'FuncDecl', 'TypeDecl', 'IdentifierType', 'Compound', 'ArrayDecl',
                'Constant', 'ParamList', 'FuncCall', 'ID', 'ExprList', 'UnaryOp', 'For', 'Assignment', 'BinaryOp',
                'ArrayRef', 'If', 'Return', 'While', 'DeclList', 'Break', 'TernaryOp', 'PtrDecl', 'Cast', 'Typename',
                'InitList', 'Continue', 'EmptyStatement', 'StructRef', 'DoWhile', 'Struct', 'Switch', 'Case', 'Default',
                'Enum', 'EnumeratorList', 'Enumerator', 'Typedef', 'Label', 'Goto']
    for l in listchar:
