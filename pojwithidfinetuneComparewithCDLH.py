...
import network
import pycparser
from sampleC import _traverse_tree_withid
...
def train_model(infile, embeddings, epochs=EPOCHS):
    ...
    for epoch in range(1, epochs+1):
        ...
        ff = open("./datasetForCompareWithCDLH/OJ/devdata1.txt", 'r')
        line = "123"
        k = 0
        while line:
        ...
        correct_labels_test = []
        predictions_test = []
        ff = open("./datasetForCompareWithCDLH/OJ/testdata1.txt", 'r')
        line = "123"
        k = 0
        while line:
            line = ff.readline().rstrip('\n')
...
if __name__ == '__main__':
    ...
    feature_size = 100
    fz = open("sentencePOJwithid.txt", 'r')
    line = "123"
    listchar = []
    while line:
    ...
    train_model('./datasetForCompareWithCDLH/OJ/traindata1.txt', dictta)
